...
English:For the library to work, you need to add the following files to the project address: libiconv-2.dll, libintl-9.dll, libpq.dll, libxml2.dll, libxslt.dll.
...
Русский:Для работы библиотеки необходимо в папку проекта положить файлы:libiconv-2.dll, libintl-9.dll, libpq.dll, libxml2.dll, libxslt.dll
